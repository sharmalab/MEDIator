...
public class TCIAClientImpl implements ITCIAClient {
    ...
    public String getModalityValues(String collection, String bodyPartExamined,
                                    String modality, OutputFormat format) throws edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException {
        try {
        ...
        } catch (edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException e) {
            throw e;
        } catch (Exception e) {
            throw new edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException(e, baseUrl);
        }

    }

    public InputStream getRawData(URI uri) throws edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException, ClientProtocolException, IOException {
...
// error
        {
            ...
            {
                throw new edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException(uri.toString(),
                        "Unauthorized access");
            } else if (response.getStatusLine().getStatusCode() == 404) {
                throw new edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException(uri.toString(),
                        "Resource not found");
            } else {
                throw new edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException(uri.toString(), "Server Error : "
            ...
            if (entity != null && entity.getContent() != null) {
                ...
                throw new edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException(baseUrl, "No Content");
            }
        }
    }
    ...
    public String getManufacturerValues(String collection,
            ...
            throws edu.emory.bmi.mediator.ds_mgmt.tcia.TCIAClientException {
        try {
            URI baseUri = new URI(baseUrl);
